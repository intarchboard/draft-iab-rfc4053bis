...
#  Responding to Incoming Liaison Statements
   ...
   When there is no response to incoming liaison statement that
   indicates that it is for "information" or "comment", other SDOs
   should not see this as there is agreement or concurrence  or there
   is group or IETF level consensus on such topic raised with or to
   the IETF. IETF positions require community rough consensus with
   input from Working Groups via process managed by the Internet
