...
2. The section on Content of a Liaison Statement has been revised to
...
3. The purpose "For comment" has been removed as either "For information" or "For Action" can be used instead;
...
4. New section on "Recording Liaison Statements" that replaces Section 2.4. on "Lifetime of a Liaison Statement"
...
5. Section 4 from RFC4052 on "Approval and Transmission of Liaison Statements" has been moved to this document, without modification so far.
